      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="grid md:grid-cols-3 gap-4">
          <div className="relative flex items-center">
            <label htmlFor="alert-target-rate" className="sr-only">Target Rate</label>
            <input
              id="alert-target-rate"
              name="alert-target-rate"
              type="number"
              step="any"
              value={targetRate}
          ...
          <label htmlFor="alert-condition" className="sr-only">Alert condition</label>
          <select
            id="alert-condition"
