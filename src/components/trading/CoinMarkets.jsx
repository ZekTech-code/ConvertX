...
function ExchangeIconWithFallback({ exchange, slug, logoUrl }) {
  ...
  return (
    <div className="w-6 h-6 shrink-0 rounded-full overflow-hidden flex items-center justify-center" style={{ background: "rgba(255,255,255,0.06)" }}>
      {!showInline && (
        <img
          src={src}
          alt=""
...
export default function CoinMarkets({ asset, darkMode, currentPrice, pricesReady, assetChange24h }) {
  ...
  useEffect(() => {
    const timer = setTimeout(() => fetchMarkets(), 0);
      ...
      {markets.length > 0 && (
        <div>
          <div className="relative mb-3">
            <label htmlFor="coin-markets-search" className="sr-only">Search markets</label>
            <input
              id="coin-markets-search"
              name="coin-markets-search"
              type="text"
              value={search}
          ...
          <div className="overflow-x-auto">
            ...
            >
              <div className="text-[10px] font-bold uppercase tracking-wider pl-8">Exchange</div>
            ...
            <div className="max-h-70 overflow-y-auto no-scrollbar" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
