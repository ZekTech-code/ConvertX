...
function getIcon(value) {
  if (value <= 25) return TrendingDown;
  if (value <= 45) return TrendingDown;
  if (value <= 55) return Minus;
  if (value <= 75) return TrendingUp;
  return TrendingUp;
}
...
export default function FearGreedIndex({ darkMode }) {
  ...
  const Icon = data ? getIcon(data.current) : Minus;
    ...
    >
      ...
      {data && (
        <>
          ...
          >
            <Icon size={28} className="mx-auto mb-2" style={{ color: style.color }} />
