...
export default function PerformanceAnalytics({ trades, positions, portfolioValue, totalPnL, initialBalance, darkMode }) {
  ...
  const seriesColors = ['#22c55e', '#ef4444', '#3b82f6', '#f59e0b', '#a855f7', '#ec4899', '#14b8a6'];
      ...
      {stats.monthlyReturns.length > 0 && (
        <div className="space-y-1">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-1">
            {stats.monthlyReturns.slice(-12).map((m, i) => (
