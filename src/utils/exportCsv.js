/**
 * exportCsv.js
 * Generates a professionally styled HTML financial report that opens in a new
 * browser tab, ready to be printed (Ctrl+P) or saved as a PDF.
 */
...
/**
 * Opens a styled HTML financial statement in a new tab.
 * The user can then Ctrl+P → Save as PDF or print directly.
 *
 * @param {Array<Object>} rows   - Conversion history records
 * @param {string}        [user] - Optional user display name
 */
...
<body>
  ...
  // ═══════════════════════════════════════════════════
  // Mobile/tablet path — try native share first
  // ═══════════════════════════════════════════════════
  ...
  if (isMobile) {
    ...
    doNativeShare().then((shared) => {
      if (!shared) {
        // Native share unavailable or cancelled → download the file
        triggerDownload(blob);
        // If share failed, still try popup so they can print
  ...
  // ═══════════════════════════════════════════════════
  // Desktop path — open in new tab with print prompt
  // ═══════════════════════════════════════════════════
  const win = window.open("", "_blank");
  if (!win) {
    triggerDownload(blob);
