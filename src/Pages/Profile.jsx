...
export default function Profile() {
  ...
  // Advanced Currency Converter Preferences
  ...
  // Premium Features - API Keys State
  ...
  const handleImageUpload = (e) => {
    ...
    reader.onload = (event) => {
      setAvatar(event.target.result); // Base64 data URL
  ...
  const handleResetProfile = async () => {
    ...
    try {
      ...
      // 1. Reset standard user details to default in AuthContext
      await updateProfile({
      ...
      // 2. Reset local states in Profile
      ...
      <main className="relative z-10 flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8 flex flex-col gap-8">
        ...
        <div className="grid lg:grid-cols-4 gap-8 items-start">
          ...
          <div className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-3xl p-4 shadow-xl shadow-slate-100 dark:shadow-none backdrop-blur-xl space-y-1.5">
            ...
            {/* <button
              onClick={() => { setActiveTab("developer"); clearNotifications(); }}
              className={`w-full text-left px-4 py-3 rounded-2xl flex items-center gap-3 text-sm font-semibold transition cursor-pointer ${
                activeTab === "developer"
                  ? "bg-linear-to-r from-[#E88F2B] to-[#d97706] text-black shadow-lg shadow-[#E88F2B]/10"
                  : "text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5"
            ...
            <div>
              ...
              {activeTab === "personal" && (
                <>
                  ...
                  {/* Profile picture upload segment */}
                  ...
                  {/* Name, Country, Phone inputs */}
                  <div className="grid sm:grid-cols-2 gap-4">
                    {/* Full Name */}
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Full Name</label>
                    ...
                    {/* Country Selector */}
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Country</label>
                      <CountryDropdown
                        value={country}
                  ...
                  {/* Phone Number */}
                  <div className="space-y-1.5">
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Phone Number</label>
                  ...
                  {/* Biography */}
                  <div className="space-y-1.5">
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Biography / Tagline</label>
                    <div className="relative">
              ...
              {activeTab === "preferences" && (
                <form onSubmit={handleSavePreferences} className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Default Base Currency</label>
                      <select
                        value={defaultFrom}
                    ...
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Default Target Currency</label>
                      <select
                        value={defaultTo}
                  ...
                  {/* Important Converter Preferences Grid */}
                  <div className="grid sm:grid-cols-2 gap-4 pt-4 border-t border-slate-100 dark:border-white/5">
                    {/* Display Formatting preference style */}
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Local Currency Display Style</label>
                      <select
                        value={displayStyle}
                    ...
                    {/* Decimal Precision */}
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Decimal Places Precision</label>
                      <select
                        value={decimalPlaces}
                    ...
                    {/* Auto-Refresh Rate */}
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Auto-Refresh Exchange Engine</label>
                      <select
                        value={refreshRate}
                    ...
                    {/* Volatility alarm limit */}
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Volatility Alert Alarm Bounds</label>
                      <select
                    ...
                    <div className="space-y-1.5">
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Comparison Chart View Span</label>
                      <select
                        value={chartRange}
                ...
                <div className="space-y-8">
                  <form onSubmit={handleChangePassword} className="space-y-6 max-w-md">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Current Password</label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 dark:text-slate-500">
                      ...
                      {/* New Password Field */}
                      <div className="space-y-1.5">
                        <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">New Password</label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 dark:text-slate-500">
                            <Lock className="w-4 h-4" />
                          </div>
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Confirm New Password</label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 dark:text-slate-500">
                            <Lock className="w-4 h-4" />
                          </div>
                  ...
                  {/* Security Activity Logs (Audit Logs) */}
                  ...
                  <div className="grid md:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-5 rounded-2xl bg-slate-50/50 dark:bg-black/15 border border-slate-200/50 dark:border-white/5 space-y-4">
                        <div className="space-y-1.5">
                          <label className="block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 ml-1">Select Access Scopes</label>
                          <select
                            value={newKeyScope}
